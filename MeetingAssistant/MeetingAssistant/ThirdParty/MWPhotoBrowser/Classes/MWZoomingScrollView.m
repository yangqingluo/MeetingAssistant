...
- (void)imageView:(UIImageView *)imageView longPressed:(UILongPressGestureRecognizer *)longGesture{
    [self longPressed:longGesture];
}
...
- (void)view:(UIView *)view longPressed:(UILongPressGestureRecognizer *)longGesture{
    [self longPressed:longGesture];
}
